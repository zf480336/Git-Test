...
class MainViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,HeadViewDelegate {
    ...
    func getData() {
        ...
        self.userViewModel?.resultArrayBlock = {(array:Array<Any>,isEnd:Bool) -> Void in
            ...
            self.homeViewModel.resultArrayBlock = {(array:Array<Any>,isEnd:Bool) -> Void in
                ...
                //列表信息
                self.homeViewModel.params.setValue("979", forKey: "entrepotId")
    ...
    func setRefresh() -> Void {
        ...
        self.mj_footer.setTitle("更多数据请前往我的任务", for: MJRefreshState.idle)
        self.mj_footer.setTitle("更多数据请前往我的任务", for: MJRefreshState.willRefresh)
        self.mj_footer.setTitle("更多数据请前往我的任务", for: MJRefreshState.refreshing)
        self.mj_footer.setTitle("更多数据请前往我的任务", for: MJRefreshState.noMoreData)
