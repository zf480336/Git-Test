...
//    }
    ...
    override func setViewModel() -> Void {
        ...
        self.alreadyViewModel?.setRequestDic()
        self.alreadyViewModel?.getRunningDetailTask(dic: (self.alreadyViewModel?.data)!,wayBillStatus: "4")
        self.alreadyViewModel?.resultArrayBlock = {(array:Array<Any>,isEnd:Bool) -> Void in
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        ...
        if ((self.alreadyViewModel?.orderdetailListModel?.containerList?.count) != nil) {
            return 4+(self.alreadyViewModel?.orderdetailListModel?.containerList?.count)!
        }else{
            return 4
        }
        ...
        if indexPath.section == 0 {
            ...
            if ((self.alreadyViewModel?.orderdetailListModel?.containerList?.count) != nil) {
                ...
                if indexPath.section == 2 {
                    ...
                    cell.orderContainer_listModel = self.alreadyViewModel?.orderdetailListModel?.containerList![indexPath.section - 4]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.section > 3  {
            ...
            let containModel:OrderContainer_listModel = self.alreadyViewModel?.dataArray[indexPath.section - 4] as! OrderContainer_listModel
