...
class HandleShipController: BaseViewController,UITextFieldDelegate {
    ...
    @IBAction func pressDateBtn(_ sender: Any) {
        ...
        controller.timeBlock = {(time:String) in
            self.handleModel.startTime = time
            self.setName()
        }
    ...
    @IBAction func pressChangeBtn(_ sender: Any) {
        ...
        if (self.handleModel.startHandModel != nil) && (self.handleModel.endHandModel != nil) {
    ...
    @IBAction func pressNextBtn(_ sender: Any) {
        ...
        if self.handleModel.name == nil || self.handleModel.carNum == nil || self.handleModel.startHandModel == nil || self.handleModel.endHandModel == nil || self.handleModel.startTime == nil{
