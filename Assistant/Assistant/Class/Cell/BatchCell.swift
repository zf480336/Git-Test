...
class BatchCell: UITableViewCell {
    ...
    var model:Any?{
        set{
            ...
            if self.betchBehavious == .Already_info  {
                var detailString:String =  (wayBilldetailModel?.estimate_departure_time)!
                detailString.append("\n")
    ...
    var orderContainerModel:Any?{
        set{
            ...
            if self.betchBehavious == .Already_info  {
                var detailString:String =  (model?.order?.estimate_departure_time)!
                detailString.append("\n")
